...
#define LORA_CONFIG_EU868                                                                                              \
    {                                                                                                                  \
        .frequency = 869.618, .bandwidth = 62.5, .spreading_factor = 8, .coding_rate = 8, .tx_power = 14,              \
        .preamble_len = 8, .use_crc = true, .tcxo_voltage = 1.8, .dio2_as_rf_switch = true                             \
    }

#define LORA_CONFIG_US915                                                                                              \
    {                                                                                                                  \
        .frequency = 915.0, .bandwidth = 250.0, .spreading_factor = 10, .coding_rate = 7, .tx_power = 22,              \
        .preamble_len = 16, .use_crc = true, .tcxo_voltage = 1.8, .dio2_as_rf_switch = true                            \
    }
...
#define LORA_CONFIG_CN470                                                                                              \
    {                                                                                                                  \
        .frequency = 470.0, .bandwidth = 250.0, .spreading_factor = 10, .coding_rate = 7, .tx_power = 17,              \
        .preamble_len = 16, .use_crc = true, .tcxo_voltage = 1.8, .dio2_as_rf_switch = true                            \
    }
...
static const struct board_config CURRENT_BOARD_CONFIG = {
    ...
    .gps = GPS_NONE,
    .radio_pins =
        {.mosi = 6, .miso = 5, .sck = 4, .cs = 7, .reset = 3, .busy = 2, .dio0 = -1, .dio1 = 1, .rxen = -1, .txen = -1},
    .display_pins = {.sda = -1, .scl = -1, .reset = -1, .addr = 0, .width = 0, .height = 0},
    .gps_pins = {.rx = -1, .tx = -1, .pps = -1, .enable = -1, .baud = 0},
...
#elif defined(BOARD_RAK4631) || defined(BOARD_RAK_WISMESH_REPEATER) || defined(BOARD_RAK_WISMESH_TAP) ||               \
    defined(BOARD_RAK_WISMESH_TAG) || defined(BOARD_RAK3401_1W)
static const struct board_config CURRENT_BOARD_CONFIG = {
    .name = "WisBlock 4631",
    .vendor = "RAK",
    .radio = RADIO_SX1262,
...
static const struct board_config CURRENT_BOARD_CONFIG = {
    ...
    .gps = GPS_NONE,
    .radio_pins =
        {.mosi = 6, .miso = 5, .sck = 4, .cs = 3, .reset = 2, .busy = 1, .dio0 = -1, .dio1 = 0, .rxen = -1, .txen = -1},
...
#elif defined(BOARD_SEEED_SENSECAP_SOLAR) || defined(BOARD_SEEED_WIO_TRACKER_L1) ||                                    \
    defined(BOARD_SEEED_WIO_TRACKER_L1_EINK) || defined(BOARD_SEEED_WIO_WM1110)
static const struct board_config CURRENT_BOARD_CONFIG = {
    .name = "SenseCAP Solar",
    .vendor = "Seeed",
    .radio = RADIO_LR1110,
...
#elif defined(BOARD_TRACKSENGER_SMALL) || defined(BOARD_TRACKSENGER_BIG) || defined(BOARD_PI_COMPUTER_S3) ||           \
    defined(BOARD_UNPHONE)
static const struct board_config CURRENT_BOARD_CONFIG = {
