/**
 * Heltec WiFi LoRa 32 V3 board configuration
 *
 * ESP32-S3 + SX1262 + SSD1306 128x64 OLED
 */

#ifndef BOARD_HELTEC_V3_CONFIG_H
#define BOARD_HELTEC_V3_CONFIG_H

#include "hardware/board.h"

#ifdef BOARD_HELTEC_V3

static void heltec_v3_early_init(void) {
    // Enable Vext for OLED power
    // Done in board_init
}

static const struct board_config heltec_v3_config = {
    .name = "Heltec V3",
    .vendor = "Heltec",
...
#    define CURRENT_BOARD_CONFIG heltec_v3_config

#endif // BOARD_HELTEC_V3
#endif // BOARD_HELTEC_V3_CONFIG_H
