...
void send_channel_message_v0(uint8_t channel_hash, const uint8_t* channel_secret, const char* text,
                             const char* channel_name);

/* Send encrypted message to specific channel - v1 (Enhanced security) */
void send_channel_message_v1(uint8_t channel_hash, const uint8_t* channel_secret, const char* text,
                             const char* channel_name);
